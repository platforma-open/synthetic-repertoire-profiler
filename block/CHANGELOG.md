...
- 8ac99f0: Fix "Synonymous nt variants" (`pl7.app/ntVariantCount`) reporting one sample's count
...
- 4462420: Add a "Export state matrix" setting, and stop re-running mitool on every run.
